...
* when there are differences within the $\omega(\theta^S)$, their
  distribution, along a Pareto distribution, will have the shape $k$ parameter
  greater than $0.7$ [@vehtari2021pareto]

## Leaving-One-Out Cross-Validation and PSIS

By using the Leaving-one-out technique, we might estimate the
$k$ value from the model, removing one observation each time.
...
- Point-wise
- No posterior MV gaussian distribution is assumed
