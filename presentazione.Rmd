...
| t for $\mu$ | t for $\sigma$ | $\mu$                                    | $\sigma$                                    |
|-------------|----------------|------------------------------------------|---------------------------------------------|
| 0           | 0              | 0                                        | 1                                           |
| 1           | 0              | $\mu^{t=1} \sim p(\mu\|\sigma^{t=0}$ = 5 | 1                                           |
| 1           | 1              | 5                                        | $\sigma^{t=1} \sim p(\sigma\|\mu^{t=1}$ = 2 |
| 2           | 1              | $\mu^{t=2} \sim p(\mu\|\sigma^{t=1}$ = 7 | 2                                           |
| 2           | 2              | 7                                        | $\sigma^{t=2} \sim p(\sigma\|\mu^{t=2}$ = 4 |
| ...         | ...            | ...                                      | ...                                         |
